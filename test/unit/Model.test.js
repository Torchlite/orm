...
module.exports = describe('Model', () => {
	...
	describe('#update', () => {
		...
		it('should throw on update to instance without ID', () => {
			...
			function badFunction() {
				return user._updateSql({ name: 'John' }).toString();
			}
	...
	describe('#fetch', () => {
		it('should generate correct SQL', () => {
			...
			return user._fetchSql().toString().should.equal(expectedFetch);
		});
	});
	...
	describe('#clone', () => {
		it('should generate correct SQL', () => {
			...
			return user._cloneSql({
				createdAt: '__DEFAULT',
			}).toString().should.equal(expectedClone);
		});
	});
	...
	describe('#delete', () => {
		it('should generate correct SQL', () => {
			...
			return user._deleteSql().toString().should.equal(expected)
		});
