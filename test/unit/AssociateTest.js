...
assert(u._getSql(Team, f, 10, 50, { key: 'teamId', direction: 'desc' }) === `SELECT teams.team_id, teams.name FROM teams WHERE (team_id = 10) AND (name = 'a name') ORDER BY team_id DESC LIMIT 10 OFFSET 50`, `limit/offset failed: ${u._getSql(Team, f, 10, 50, { key: 'teamId', direction: 'desc' })}`);
